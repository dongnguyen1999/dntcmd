...
if [ -d "$update_path/dntcmd" ]; then
    ...
    $DNT_HOME/cmd/span GREEN BOLD Everything is up to date 2>> "/var/dntcmd/copyupdate.log" 
else 
    $DNT_HOME/cmd/span RED BOLD Something wrong! Check your internet connection! 2>> "/var/dntcmd/copyupdate.log" 
fi
